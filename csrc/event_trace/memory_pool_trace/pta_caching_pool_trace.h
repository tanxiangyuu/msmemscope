...
#ifndef PTA_CACHING_POOL_TRACE_H
#define PTA_CACHING_POOL_TRACE_H
...
public:
    PTACachingPoolTrace(const PTACachingPoolTrace&) = delete;
    PTACachingPoolTrace& operator=(const PTACachingPoolTrace&) = delete;

    static PTACachingPoolTrace& GetInstance()
    {
        static PTACachingPoolTrace instance;
        return instance;
    }
...
private:
    PTACachingPoolTrace();
    ~PTACachingPoolTrace() override;

    mstxDomainHandle_t ptaCachingDomain_ { nullptr };
