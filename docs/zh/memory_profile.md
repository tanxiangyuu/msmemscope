...
- 对于C脚本和Python脚本，mstx打点方式略有不同，具体信息可参考《[MindStudio Tools Extension Library接口文档]https://gitcode.com/Ascend/mstx/blob/26.0.0/docs/zh/api_reference/mstx_api_reference.md）》。
- 推荐使用C脚本示例进行mstx打点采集。
