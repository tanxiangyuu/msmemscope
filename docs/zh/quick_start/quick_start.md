...
请根据[msMemScope安装指南](../install_guide/install_guide.md)完成msMemScope工具安装。
本示例基于PyTorch框架和Ascend Extension for PyTorch插件，请根据[Ascend Extension for PyTorch 软件安装指南](https://gitcode.com/Ascend/pytorch/blob/v2.7.1/docs/zh/installation_guide/menu_installation_guide.md)完成安装。
