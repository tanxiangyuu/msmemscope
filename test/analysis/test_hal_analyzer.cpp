...
TEST(HalAnalyzerTest, do_hal_record_except_leaks) {
    ...
    memRecordMalloc1.subtype = RecordSubType::MALLOC;
    ...
    memRecordMalloc2.subtype = RecordSubType::MALLOC;
    ...
    memRecordMalloc4.subtype = RecordSubType::MALLOC;
...
TEST(HalAnalyzerTest, do_record_except_no_leaks) {
    ...
    memRecordFree.subtype = RecordSubType::FREE;
...
TEST(HalAnalyzerTest, do_record_excpet_double_free) {
    ...
    memRecordFree1.subtype = RecordSubType::FREE;
    ...
    memRecordFree2.subtype = RecordSubType::FREE;
